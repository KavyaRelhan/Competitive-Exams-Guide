...
function Signup() {
  ...
  const handleSignup = async (e) => {
    ...
    try {
      const url = "https://competitive-exams-guide.vercel.app/auth/signup";
  ...
  const handleGoogleSuccess = async (credentialResponse) => {
    try {
      ...
      const res = await axios.post("https://competitive-exams-guide.vercel.app/auth/google-login", { token: credential });
