...
function Profile({isAuthenticated}) {
  ...
  const fetchFavorites = async (email) => {
    try {
      const response = await axios.get('http://competitive-exams-guide.vercel.app/auth/favorites', {
        params: { email },
      });
  ...
  const handleRemoveFavorite = async (url) => {
    try {
      await axios.delete('http://competitive-exams-guide.vercel.app/auth/favorites', {
